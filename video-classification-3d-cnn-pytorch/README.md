...
```
python main.py --input ./input --video_root ../data/train-video --output ./output.json --model ../data/resnext-101-64f-kinetics.pth --mode score --model_name resnext --model_depth 101 --resnet_shortcut B
```
